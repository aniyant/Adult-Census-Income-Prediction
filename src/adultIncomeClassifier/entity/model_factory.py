...
class ModelFactory:
    ...
    def execute_grid_search_operation(self, initialized_model: InitializedModelDetail, input_feature,
        ...
        try:
            ...
            message = f'{">>"* 5} f"Training {type(initialized_model.model).__name__} Started." {"<<"*5}'
            logger.info(message)
            grid_search_cv.fit(input_feature, output_feature)
            message = f'{">>"* 5} f"Training {type(initialized_model.model).__name__}" completed {"<<"*5}'
